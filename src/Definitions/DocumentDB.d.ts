...
declare module 'DocumentDB' {
    ...
    function createClient(urlConnection: string, auth: any, connectionPolicy?: any, consistencyLevel?: any): DocumentClient;
    ...
    */
    ...
    interface IndexingPolicy {
        ...
        /** An array of paths to be incuded for indexing. */
        includedPaths: IncludedPath[];

        /** An array of paths to be excluded from indexing. */
    ...
    export class DocumentClient {
        ...
        */
         ...
         */
        public queryDatabases(query: string, options?: any): QueryIterator<DatabaseMeta>;
        ...
        */
        ...
        public readDatabases(options?: RequestOptions): QueryIterator<DatabaseMeta>;
        public readDatabase(databaseLink: string, options?: RequestOptions, callback?: RequestCallback<any>): QueryIterator<DatabaseMeta>;
        public readCollections(databaseSelfLink: string, options?: RequestOptions): QueryIterator<CollectionMeta>;
        public readDocuments(collectionLink: string, options?: RequestOptions): QueryIterator<any>;
    }
}
